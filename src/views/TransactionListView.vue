  ...
  <div class="page page--is-transaction-new-view">
    ...
    <div class="page--content">
      <div class="page--content--row">
        <div class="data-list" v-for="(trOfDate, index) in transactionsByDate" :key="trOfDate">
          <div class="data-list--item">{{ trOfDate.valueDateStr }}</div>
          <div class="data-list--item" v-for="(item, index) in trOfDate.transactions" :key="item.t_id"
